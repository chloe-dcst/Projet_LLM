...
J'ai choisi d'abandonner la spécialité HGGSP car c'était celle où j'avais le plus de difficultés et je savais que je voulais m'orienter vers des études à dominante scientifique, et plus particulièrement en **mathématiques**.
...
À la suite de ces portes ouvertes, j'ai été conquise par la formation et même par le côté **informatique et programmation**, alors que je n'en avais jamais fait auparavant. En terminale, après avoir revu les projets réalisés par les étudiants, mon choix était confirmé.
...
- **Mathématiques appliquées** – statistiques, probabilités
- **Matières transversales** – gestion, économie, communication

Elle m'a aussi permis de découvrir de nouvelles matières comme la **gestion**, l'**économie** ou la **communication**, qui enrichissent ma vision du métier de data scientist.
...
- Création de **tableaux de bord** pour le suivi de l'activité des équipes métiers
...
L'alternance offre :
- Une **expérience professionnelle concrète** valorisable sur le CV
- Un **réseau professionnel** en construction
- Une **meilleure compréhension** des enjeux métiers
- Une **autonomie financière** pendant les études
- Un **apprentissage bidirectionnel** entre théorie et pratique
...
- **Apprentissage par projet** – mise en pratique immédiate des concepts
- **Travail collaboratif** – échange de connaissances et entraide
- **Recherche autonome** – développement de l'autonomie face aux problèmes
- **Veille technologique** – curiosité pour les nouvelles technologies
- **Documentation personnelle** – création de ressources pour référence future
...
- **Capacité d'adaptation** face à de nouveaux langages et outils
- **Esprit critique** dans l'analyse de données et de résultats
- **Communication technique** – expliquer des concepts complexes simplement
- **Gestion de projet** – planification, organisation, respect des délais
- **Travail en équipe** – collaboration efficace dans des groupes variés
