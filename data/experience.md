...
J'ai intégré l'équipe *Pilotage – Opérationnel* de la direction **Santé Prévoyance**, une position stratégique qui me permet de travailler au cœur des processus décisionnels de l'entreprise.
...
- L'**aide à la décision** pour les managers
...
- Création de processus reproductibles et maintenables
...
- **Visualisation de données** – choix des graphiques appropriés, design efficace
...
- **Rigueur** – fiabilité des données et des analyses
- **Adaptation** – flexibilité face aux demandes variées
- **Gestion du temps** – équilibre entre école et entreprise
- **Travail en équipe** – collaboration avec les équipes métiers
...
- Les **indicateurs hebdomadaires** de suivi
- Les **alertes automatiques** en cas d'anomalie
...
**Techniquement :**
- Maîtrise approfondie des outils BI professionnels
- Compréhension des architectures de données en entreprise
- Optimisation et industrialisation du code
...
- **Communication** avec l'école et l'entreprise pour coordonner les exigences
- **Efficacité** dans le travail pour optimiser le temps disponible
...
1. **Une expérience concrète** valorisable sur le CV
2. **Une meilleure employabilité** à la sortie de la formation
3. **Une compréhension approfondie** du métier de data analyst
4. **Un apprentissage continu** entre théorie et pratique
5. **Une autonomie financière** pendant les études
...
- La **visualisation de données** et le storytelling
...
- Ma maîtrise des **technologies big data**
...
- **Data Engineer** – architecture et industrialisation
- **Chef de projet data** – gestion de projets stratégiques
...
- **Gestion du stress** dans des situations tendues
- **Autorité** et **assurance** dans mes choix
- **Impartialité** et **objectivité**
- **Communication** claire et assertive

Ces compétences sont particulièrement utiles dans le monde professionnel, notamment pour :
- Présenter des analyses devant un public
- Défendre des recommandations basées sur les données
- Gérer des situations de désaccord
