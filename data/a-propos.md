...
Passionnée par la **visualisation de données** et la **création d'outils décisionnels**, j'ai choisi la spécialité **VCOD** (Visualisation, Conception d'Outils Décisionnels) pour ma deuxième année de BUT.
...
- **EasyPHP / phpMyAdmin** – gestion de bases de données
- **Compass (MongoDB)** – bases NoSQL
- **DBeaver** – administration de bases de données
...
- **Présentation de données** – storytelling et argumentation
- **Datavisualisation** – création de tableaux de bord pertinents
...
- **Confiance** et **assurance** dans les prises de décision
- **Adaptabilité** entre vie étudiante et professionnelle
